...
namespace GEP.Migrations
{
    ...
    [Migration("20200907213517_updateUserTFCS")]
    partial class updateUserTFCS
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GEP.Models.File.File", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GEP.Models.Notifications.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GEP.Models.UserTFC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GEP.Models.UserTFC", b =>
                {
                    b.HasOne("GEP.Models.User", "Professor")
                        .WithMany()
                        .HasForeignKey("ProfessorId");

                    b.HasOne("GEP.Models.TFC", "TFC")
                        .WithMany()
                        .HasForeignKey("TFCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
